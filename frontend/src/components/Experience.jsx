      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-12">
          {data.map((experience, index) => (
            <Card key={experience.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 bg-white border-0 shadow-lg">
              <CardContent className="p-0">
                <div className="md:flex">
                  {/* Company Info */}
                  <div className="md:w-1/3 bg-gradient-to-br from-emerald-500 to-emerald-600 p-8 text-white">
                    <div className="space-y-4">
                      ...
                      {/* Technologies */}
                      <div className="pt-4">
                        <h5 className="text-sm font-semibold mb-3 text-emerald-100">Key Technologies:</h5>
            ...
            <CardContent className="p-0">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-emerald-600 font-medium">Indian Institute of Technology</p>
                </div>
                <div>
                  ...
                  <p className="text-emerald-600 font-medium">Madras Institute of Technology</p>
                </div>
              </div>
            </CardContent>
          </Card>
