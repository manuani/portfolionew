    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="grid grid-cols-2 gap-6">
            {data.achievements.map((achievement, index) => (
              <Card key={index} className="text-center p-6 hover:shadow-lg transition-shadow bg-white border border-purple-100 shadow-md hover:border-purple-200">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <Card className="text-center p-6 hover:shadow-lg transition-all hover:-translate-y-1 bg-white border border-purple-100 shadow-md hover:border-purple-200">
            <CardContent className="p-0">
